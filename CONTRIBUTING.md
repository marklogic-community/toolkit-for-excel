# Contributing to the MarkLogic Toolkit for Excel
...
Fork the project [on GitHub](https://github.com/marklogic-community/toolkit-for-excel/fork) and clone
your copy.

```sh
$ git clone git@github.com:username/toolkit-for-excel.git
$ cd toolkit-for-excel
$ git remote add upstream git://github.com/marklogic-community/toolkit-for-excel.git
```
...
Go to https://github.com/username/toolkit-for-excel and select your feature branch. Click
...
[issue tracker]: https://github.com/marklogic-community/toolkit-for-excel/issues
