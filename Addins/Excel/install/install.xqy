...
declare variable $config:CPF-SRC-PATH :=
          "C:\Users\paven\Desktop\Excel\cpf\";
...
try{
  ...
  return (xdmp:save($dest-support, $support-doc),
          ...
          fn:concat("Step 1: install-xqy-support(); ",$support-file," copied to ",$openxml-path),
          fn:concat("Step 1: install-xqy-support(); ",$cpf-action," copied to ",$cpf-path),
          fn:concat("Step 1: install-xqy-support(); ",$cpf-config," copied to ",$install-path)
          )
