...
<script type="text/javascript" src="js/MarkLogicPowerPointAddin.js?rand='{xdmp:random()}'">//</script>
<script type="text/javascript" src="js/MarkLogicPowerPointEventSupport.js?rand='{xdmp:random()}'">//</script>
