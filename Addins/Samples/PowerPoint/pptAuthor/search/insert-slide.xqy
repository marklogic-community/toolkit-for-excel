...
let $custom-slide-metadata := $doc-props/prop:properties/ppt:slidetags/ppt:tag[@ppt:rid = $rId]/ppt:custompart
let $custom-shape-metadata := $doc-props/prop:properties/ppt:shapetags/ppt:shape/ppt:tag/ppt:custompart

let $metadata := for $meta in  ($custom-slide-metadata,$custom-shape-metadata)
