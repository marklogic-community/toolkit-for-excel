Following are quick up-and-running instructions for those who have already installed the MarkLogic Toolkit for Word and deployed the Sample application included with the Toolkit.

Deploying the MarkLogic Authoring Sample App for Word is just as simple,but once deployed into your App Server, 3 areas require update for the application to work properly.

To get started using the Sample Application:

1) Set the registry entry for the Addin to the URL of this application

The key to update is: HKEY_CURRENT_USER/MarkLogicAddinConfiguration/Word/URL
