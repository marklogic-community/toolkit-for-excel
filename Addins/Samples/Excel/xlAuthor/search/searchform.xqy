...
let $header:=
		      ...
		      <!--<input id="ML-Submit" type="submit" value="search"/>-->
                      ...
                      <div id="searchtype">
                      {
                         ...
                         { (:
                         if($searchtype eq "worksheet")
                         then
                            <input type="radio" class="searchtype" name="search:bst" value="worksheet" checked="checked" id="s"/>
                         else
                            <input type="radio" class="searchtype" name="search:bst" value="worksheet" id="s"/>:)
                         } <!--Worksheets-->
                         {
                         if($searchtype eq "workbook")
                         then
                     ...
                     }Workbooks
                     {
                         ...
                         then
                            <input type="radio" class="searchtype" name="search:bst" value="macro" checked="checked" id="p"/>
                         else
                            <input type="radio" class="searchtype" name="search:bst" value="macro" id="p"/>
                      }Macros
