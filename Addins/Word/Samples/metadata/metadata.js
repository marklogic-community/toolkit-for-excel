		...
		.observe(
				...
				function() {
					...
					function updateMetadata() {
						$("v_fc").innerHTML = "Saving metadata…";
						var edited = false;
					 ...
					 * updateMetadata() }); $("ML-Remove").observe("click",
					 * function(e) { removeMetadata() });
					 */
					[ "ML-Title", "ML-Desc", "ML-Publisher", "ML-Id" ]
							.each( function(el) {
					...
					for (i = 0; i < customPieceIds.length; i++) {
						if (customPieceIds[i] == null || customPieceIds == "") {
							...
							customPieceId = customPieceIds[i];
							tmpCustomPieceXml = MLA
									.getCustomPiece(customPieceId);
					...
					var v_description = xmlDoc
							.getElementsByTagName("dc:description")[0].childNodes[0].nodeValue;
					var v_publisher = xmlDoc
							.getElementsByTagName("dc:publisher")[0].childNodes[0].nodeValue;
					var v_identifier = xmlDoc
							.getElementsByTagName("dc:identifier")[0].childNodes[0].nodeValue;
